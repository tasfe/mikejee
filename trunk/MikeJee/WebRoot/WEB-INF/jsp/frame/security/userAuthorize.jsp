...
<script type="text/javascript" src="<%= path %>/js/frame/security/userAuthorize.js"></script>
<title>人员授权</title>
<script>
	//
</script>
...
<body class="easyui-layout">
	 ...
	 <div id="content" region="center" title="" style="padding:0px;">
		<div id="tt" style="width:350px;height:330px;padding:0px;" border="false">  
		    <div title="选择角色" closable="false" style="padding:10px;">  
		        <div id="grantRoleTree"></div> 
		    </div>
